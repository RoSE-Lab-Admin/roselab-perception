...
size_t size_function__Capture_Request__sensors(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Capture_Request__sensors(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__Capture_Request__sensors(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__Capture_Request__sensors(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__Capture_Request__sensors(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__Capture_Request__sensors(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__Capture_Request__sensors(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__Capture_Request__sensors(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Capture_Request_message_member_array[3] = {
  {
    "outname",  // name
    ...
    offsetof(gantry_lidar_interfaces::srv::Capture_Request, outname),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gantry_lidar_interfaces::srv::Capture_Request, sensors),  // bytes offset in struct
    nullptr,  // default value
    size_function__Capture_Request__sensors,  // size() function pointer
    get_const_function__Capture_Request__sensors,  // get_const(index) function pointer
    get_function__Capture_Request__sensors,  // get(index) function pointer
    fetch_function__Capture_Request__sensors,  // fetch(index, &value) function pointer
    assign_function__Capture_Request__sensors,  // assign(index, value) function pointer
    resize_function__Capture_Request__sensors  // resize(index) function pointer
  },
  {
    "duration",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gantry_lidar_interfaces::srv::Capture_Request, duration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Capture_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gantry_lidar_interfaces::srv::Capture_Response, outdata),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
