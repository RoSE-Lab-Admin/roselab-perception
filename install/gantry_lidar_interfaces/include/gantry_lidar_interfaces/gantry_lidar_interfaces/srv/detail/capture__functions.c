...
gantry_lidar_interfaces__srv__Capture_Request__init(gantry_lidar_interfaces__srv__Capture_Request * msg)
{
  ...
  // outname
  if (!rosidl_runtime_c__String__init(&msg->outname)) {
    gantry_lidar_interfaces__srv__Capture_Request__fini(msg);
    return false;
  }
  // sensors
  if (!rosidl_runtime_c__String__Sequence__init(&msg->sensors, 0)) {
    gantry_lidar_interfaces__srv__Capture_Request__fini(msg);
    return false;
  }
  // duration
...
gantry_lidar_interfaces__srv__Capture_Request__fini(gantry_lidar_interfaces__srv__Capture_Request * msg)
{
  ...
  // outname
  rosidl_runtime_c__String__fini(&msg->outname);
  // sensors
  rosidl_runtime_c__String__Sequence__fini(&msg->sensors);
  // duration
}
